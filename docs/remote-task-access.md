...
[ADR-0027](decisions/0027-remote-task-access-gateway.md). Code:
...
| `403 workstream_denied` | pinned token, or a pinned token that names several workstreams without an explicit `--workstream` | pass the workstream explicitly |
